...
### Версия 2024.06.01
  ...
  * Добавление канала обновления для переводчиков и тестирования новых функций
  * Добавление турецкого перевода
  * При сохранении документа Word каждая страница в файле добавляется как новая.
  * Добавление сообщения о загрузке дополнения в журнал NVDA.

## What's new?
  ...
  * Adding a message during the module installation indicating that statistical data is being collected. The information includes: installed module version, version under installation, the system language and the keyboard language
